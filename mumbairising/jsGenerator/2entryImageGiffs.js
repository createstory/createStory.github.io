class EntryImageGiffs {
  constructor(w_, h_){
    this.w = w_;
    this.h = h_;

    this.is = int(random(pgImagesGiffsCount));
    this.currentImage = pgImagesGiffs[this.is];
    ...
    if(this.imageH > pgImagesGiffs[this.is].height || this.imageW > pgImagesGiffs[this.is].width){
      this.imageW = pgImagesGiffs[this.is].width;
      this.imageH = pgImagesGiffs[this.is].height;
    }
  }
